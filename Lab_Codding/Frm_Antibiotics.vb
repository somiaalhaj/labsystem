...
#End Region
#Region "Events ---------"
    Private Sub Frm_Antibiotics_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
...
#Region "Functions -----------"
    Private Sub Get_Antibiotics()
        Try
            ...
            Dim Sql_ As Object = New String("select * from Antibiotics")
    ...
    Private Sub BindingContext_Data(ByVal Dt_Ref As DataTable)
        Try
            If Not Dt_Ref.Rows.Count <= 0 Then
                Me.Text_Anti_No.DataBindings.Add("Text", Dt_Ref, "Anti_No")
                Me.Text_Anti_Name.DataBindings.Add("Text", Dt_Ref, "Anti_Name")
...
#Region "Functions Of DataBase "
    Private Sub New_()
        Try
            Me.Text_Anti_No.Text = Nothing
            Me.Text_Anti_Name.Text = Nothing
            Me.Text_Anti_No.Text = Get_Max("Antibiotics", "Anti_No")
            Flg_ = 1
            Controls_False()
        ...
        Try
            If Flg_ = 1 Then
                ...
                If Msg_Re = MsgBoxResult.Ok Then
                    If Not Conn.State = ConnectionState.Open Then
                        Conn.Open()
                    End If
                    Dim Var1_No_ As Object = Me.Text_Anti_No.Text.Trim
                    Dim Var2_Name_ As Object = Me.Text_Anti_Name.Text.Trim
                    Insert_("Antibiotics", "Anti_No,Anti_Name", "" & Var1_No_ & ",'" & Var2_Name_ & "'")
                    Get_Antibiotics()
                    Flg_ = 0
                    Controls_()
                    Me.GroupBox1.Enabled = False
            ...
            ElseIf Flg_ = 2 Then
                ...
                If Msg_Re = MsgBoxResult.Ok Then
                    ...
                    Dim Sql_ = "UPDATE Antibiotics SET Anti_Name='" & Var2_Name_ & "'   WHERE Anti_No=" & Var1_No_ & ""
