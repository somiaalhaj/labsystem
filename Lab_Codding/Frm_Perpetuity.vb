...
#End Region
#Region "Events -------------"
    Private Sub Frm_Perpetuity_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        On Error Resume Next

        Fill_Cmb_(Me.Comb_Timing, "Timming", "Timming_No", "Timming_Name", " Active=0")
...
#Region "Functions -----------"
    Private Sub Get_Perpetuity()
        Try
            ...
            Dim Sql_ As Object = New String("SELECT * FROM Perpetuity")
    ...
    Private Sub BindingContext_Data(ByVal Dt_Ref As DataTable)
        Try
            If Not Dt_Ref.Rows.Count <= 0 Then
                Me.Text_Per_No.DataBindings.Add("Text", Dt_Ref, "Per_No")
                Me.Text_Attending_Time.DataBindings.Add("Text", Dt_Ref, "Attending_Time")
                Me.Text_Scramming_Time.DataBindings.Add("Text", Dt_Ref, "Scramming_Time")
                Me.Comb_Timing.DataBindings.Add("SelectedValue", Dt_Ref, "Timming_N0")
...
#Region "Functions Of DataBase "
    Private Sub New_()
        Try
            Me.Text_Per_No.Text = Nothing
            Me.Text_Attending_Time.Text = Nothing
            Me.Text_Scramming_Time.Text = Nothing
            Me.Comb_Timing.Text = Nothing

            Me.GroupBox1.Enabled = True
            Me.Text_Per_No.Text = Get_Max("Perpetuity", "Per_No")
            Flg_ = 1
            Controls_False()
        Catch ex As Exception
            MsgBox(ex.Message)
        ...
        Try
            ...
            If Msg_Re = MsgBoxResult.Ok Then
                If Not Conn.State = ConnectionState.Open Then
                    Conn.Open()
                End If
                Dim Var1_No_ As Object = Me.Text_Per_No.Text.Trim
                Dim Sql_ = "DELETE  FROM Perpetuity WHERE Per_No=" & Var1_No_ & ""
        ...
        Try
            If Flg_ = 1 Then
                ...
                If Msg_Re = MsgBoxResult.Ok Then
                    ...
                    Dim Var1_No_ As Object = Me.Text_Per_No.Text.Trim
                    Dim Var2_Attending_ As Object = Me.Text_Attending_Time.Text.Trim
                    Dim Var2_Scramming_ As Object = Me.Text_Scramming_Time.Text.Trim
                    Dim var2_Comb_Timing_ As Object = Me.Comb_Timing.SelectedValue.ToString


                    Dim Sql_ = "insert Into Perpetuity (Per_No , Attending_Time , Scramming_Time , Timming_N0 ) VALUES (" & Var1_No_ & "," & Var2_Attending_ & " ," & Var2_Scramming_ & " , '" & var2_Comb_Timing_ & "')"
            ...
            ElseIf Flg_ = 2 Then
                ...
                If Msg_Re = MsgBoxResult.Ok Then
                    ...
                    Dim Sql_ = "UPDATE  Perpetuity SET Attending_Time=" & Var2_Attending_ & " , Scramming_Time=" & Var2_Scramming_ & " , Cate_Unit_No='" & var2_Comb_Timing_ & "'  WHERE Per_No=" & Var1_No_ & ""
